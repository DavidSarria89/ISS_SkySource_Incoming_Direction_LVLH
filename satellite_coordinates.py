...
class satellite_coordinates:
    ...
    Returns the longitude (deg), latitude (deg), altitude (km) of a satellite at a given time
        ...
        v_vec_ecef_itrf =  velocity/math.sqrt(velocity[0]*velocity[0]+velocity[1]*velocity[1]+velocity[2]*velocity[2])
        #print("velocity vector: ", v_vec_ecef_itrf)
        ...
        return lon, lat, alt, v_vec_ecef_itrf
